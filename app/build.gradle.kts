...
android {
    namespace = "com.daryeetey.weatherapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.daryeetey.weatherapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
// Hilt testing dependencies (optional but recommended for ViewModel testing)
...
kapt {
    ...
    mapDiagnosticLocations = true // Helps pinpoint errors
}